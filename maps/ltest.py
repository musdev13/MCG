# filepath: {gamePath}/maps/ltest.py
import pygame
import time
...
class ltest:
    def __init__(self, screen, gamePath=gamePath):
        ...
        self.backgrounds.append(pygame.image.load(f"{gamePath}/img/ltest/bg_1.png"))
        self.backgrounds.append(pygame.image.load(f"{gamePath}/img/ltest/bg.png"))
